...
export default function HowItWorks() {
  return (
    <section id="como-funciona" className="py-20 bg-[#1B3A5C]">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          ...
          <div className="hidden md:block absolute top-8 left-1/3 right-1/3 h-px bg-[#C8A96E]/30" />

          {steps.map((step) => (
            <div key={step.step} className="relative text-center">
              {/* Número */}
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#C8A96E] text-white font-serif text-2xl font-bold mb-6 relative z-10">
                {step.step}
              </div>
        ...
        <div className="text-center mt-12">
          <a
            ...
            className="inline-flex items-center gap-2 bg-[#C8A96E] hover:bg-[#b8965a] text-white font-semibold px-8 py-3 rounded-full transition-colors"
          >
