    ...
    <section id="contato" className="bg-[#1966C9] py-16 md:py-20">
      <div className="mx-auto max-w-3xl px-4 text-center text-white sm:px-6">
        ...
        <a
          ...
          className="inline-flex w-full items-center justify-center gap-3 rounded-full bg-[#25D366] px-8 py-4 text-base font-bold text-white shadow-[0_14px_34px_rgba(37,211,102,0.32)] transition-colors hover:bg-[#20bd5a] sm:w-auto"
        >
