...
function StarIcon() {
  return (
    <svg className="w-4 h-4 fill-[#C8A96E] text-[#C8A96E]" viewBox="0 0 20 20">
          ...
          {testimonials.map((t) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-gray-100">
                {/* Avatar placeholder */}
                <div className="w-9 h-9 rounded-full bg-[#1B3A5C]/10 flex items-center justify-center text-[#1B3A5C] font-semibold text-sm">
                  {t.name.charAt(0)}
                </div>
                <div>
